...
*   **Context Window Truncation:** During extremely long survival runs, the accumulated daily narrative logs may exceed the LLM's maximum token context window, causing the AI to occasionally "forget" earlier events or specific survivor relationships.
