import pytest
from utils.game_logic import get_initial_game_state, has_sufficient_resources
...
def test_has_sufficient_resources_success() -> None:
    ...
    cost = {"food": 5, "wood": 2}
    assert has_sufficient_resources(resources, cost) is True
...
def test_has_sufficient_resources_failure() -> None:
    ...
    cost = {"food": 5, "wood": 2}
    assert has_sufficient_resources(resources, cost) is False